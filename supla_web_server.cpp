...
//  CZUJNIK SDS011
  ...
  // AQI.ECO
    ...
    content += "<input class='text' type='text' name='aqi_eco_host' value='" + String(read_aqi_eco_host().c_str()) +   "'>";   
    content += "<label>AQI.ECO HOST</label>";
    content += "</i>";
    content += "<i>";
    content += "<input class='text' type='text' name='aqi_eco_path' value='" + String(read_aqi_eco_path().c_str()) + "'>";     
  ...
  // AIR.MONITOR
    ...
    content += "<i>";
    content += "<input class='text' type='text' name='airMonitorServer' value='" + String(read_air_monitor_server().c_str()) + "'>";  
    content += "<label>airMonitor HOST</label>";
    content += "</i>";
    
    content += "<i>";
    content += "<input class='text' type='text' name='airMonitor_latitude' value='" + String(read_air_monitor_latitude().c_str()) + "'>"; 
    content += "<label>Szer. geogr.</label>";
    content += "</i>";
    content += "<i>";
    
    content += "<input class='text' type='text' name='airMonitor_longitude' value='" + String(read_air_monitor_longitude().c_str()) + "'>"; 
